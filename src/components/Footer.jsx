...
export default function Footer() {
  ...
  return (
    <footer 
      ...
      className="border-t py-16 px-6 md:px-24 mt-24 transition-colors duration-700 relative z-50"
    >
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
        ...
        <div>
          <h3 className="text-xs font-bold tracking-widest uppercase opacity-70 mb-5">Quick Links</h3>
        ...
        {/* Column 4: Operations & Location */}
        <div>
          <h3 className="text-xs font-bold tracking-widest uppercase opacity-70 mb-5">Operations</h3>
          <p className="text-xs md:text-sm font-light opacity-80 leading-relaxed mb-3">
